...
<div class="users view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Link Mobile') ?></th>
            <td><?= h($user->link_mobile) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Dia Chi') ?></th>
        ...
        <tr>
            <th scope="row"><?= __('Pd Mobile') ?></th>
            <td><?= $this->Number->format($user->pd_mobile) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Sdt') ?></th>
            <td><?= $this->Number->format($user->sdt) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><?= __('Ngay Het Han') ?></th>
            <td><?= h($user->ngay_het_han) ?></td>
        </tr>
        <tr>
