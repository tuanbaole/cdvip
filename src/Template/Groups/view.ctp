    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Link Mobile') ?></th>
                <th scope="col"><?= __('Pd Mobile') ?></th>
                <th scope="col"><?= __('Ngay Het Han') ?></th>
                <th scope="col"><?= __('Sdt') ?></th>
                <th scope="col"><?= __('Dia Chi') ?></th>
            ...
            <tr>
                ...
                <td><?= h($users->link_mobile) ?></td>
                <td><?= h($users->pd_mobile) ?></td>
                <td><?= h($users->ngay_het_han) ?></td>
                <td><?= h($users->sdt) ?></td>
                <td><?= h($users->dia_chi) ?></td>
